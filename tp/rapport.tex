...
\item La formule de taylor à l'ordre 4 donne :
  ...
  \begin{equation*}
    ...
    \begin{array}{lllllll}
      ...
      0 & 0 & 0 \\
      - & - & - & - & - & - & - \\
      0 & 0 & 0 &- \frac{1}{h^2} & \frac{2}{h^2} + c(u_{n-2}) & - \frac{1}{h^2} &
      0 \\
      0 & 0 & 0 & 0 &- \frac{1}{h^2} & \frac{2}{h^2} + c(u_{n-1}) & - \frac{1}{h^2} \\
      0 & 0 & 0 & 0 & 0 &- \frac{1}{h^2} & \frac{2}{h^2} + c(u_n)
    \end{array}
    \right]
  \end{equation*}
  ...
  \item
    \begin{equation*}
      ...
      \left(- \frac{1}{h^2} \right) w_3 \right) \\
      + & ----- \\
      + & h^2 \left(w_{n-1} \left(\frac{2}{h^2} + c(u_n) \right) w_{n-1} + w_n
      \left(- \frac{1}{h^2} \right) w_n \right) \\
      = & \sum_{i=1}^{n-1} {(2 + h^2c(ih)) w_i^2} - 2 \sum_{i=2}^{n} {w_{i-1}w_n}
      \end{split}
    \end{equation*}
