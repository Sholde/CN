...
\item Calculons $f(-2), f(-1), f(0), f(1), f(2)$ :
  ...
  \begin{equation*}
    \begin{split}
      ...
      f(-2) & = \ln(2(\frac{3\pi}{2})^2 + 1) \\
      f(-2) & = \ln(2(\frac{9\pi^2}{4}) + 1) \\
      f(-2) & = \ln(\frac{18\pi^2}{4} + 1) \\
      f(-2) & = \ln(\frac{18\pi^2 + 4}{4}) \\
      f(-2) & = 3,8
    \end{split}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{split}
      ...
      f(-1) & = \ln(2(\frac{3\pi}{2})^2 + 1) \\
      f(-1) & = \ln(2(\frac{9\pi^2}{4}) + 1) \\
      f(-1) & = \ln(\frac{18\pi^2}{4} + 1) \\
      f(-1) & = \ln(\frac{18\pi^2 + 4}{4}) \\
      f(-1) & = 3,8
    \end{split}
  \end{equation*}
